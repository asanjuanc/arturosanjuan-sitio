...
subtitle: "Apuntes de clase: curvas, pendientes y áreas en coordenadas polares"
...
$$A = \frac12\int_0^\pi \sin^2\theta\,d\theta = \frac14\int_0^\pi(1-\cos2\theta)\,d\theta = \frac14\left[\theta-\frac12\sin2\theta\right]_0^\pi = \frac{\pi}{4}$$

::: {.callout-note title="Hacer las cuentas — código Maxima"}
```maxima
kill(all);
integrate(1/2*sin(theta)^2, theta, 0, %pi);
```
:::
